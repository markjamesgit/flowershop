...
if (isset($_POST["delete_selected"])) {
    if (isset($_POST["selected_categories"]) && is_array($_POST["selected_categories"])) {
        foreach ($_POST["selected_categories"] as $selectedflowerId) {
            $deleteQuery = "DELETE FROM flower WHERE id = $selectedflowerId";
            mysqli_query($conn, $deleteQuery);
        }
        echo "<script>alert('Selected flower deleted successfully');</script>";
    } else {
        echo "<script>alert('No flowers selected for deletion');</script>";
    }
}
...
$searchQuery = "SELECT * FROM flower WHERE flower LIKE '%$searchTerm%'";
    ...
    <div class="all">
        ...
        <div class="view">
            ...
            <form action="" method="get">
                <label for="search" class="text5">Search Flower:</label>
                <input type="text" name="search" class="searchtxt" id="search" placeholder="Enter flower name" required />
